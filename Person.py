...
# person = Person(name="Bence", address="Ghioceilor")
# print(person)
# person.address = "Lala"
...
# teacher = Teacher(name="Andreea", address="Donut")
# print(teacher)

# my_list = ["Ändreea", "Ändreea", "Ändreea", "Ändreea", "Ändreea"]
# for i in my_list:
#     var = teacher.add_course("Math")
#     print(var)
